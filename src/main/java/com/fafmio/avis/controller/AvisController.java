package com.fafmio.avis.controller;
...
import com.fafmio.avis.dto.UtilisateurDTO;
...
//		mav.getModelMap().addAttribute("utilisateur", new UtilisateurDTO());
	...
	public ModelAndView jeuGet(@ModelAttribute Jeu jeu, @RequestParam(name="ID", required=false) Long id) {
